...
//        
    ...
    public static Transform createRotateTransform(float angle) {   
        return new Transform(MathUtils.cos(angle), -MathUtils.sin(angle), 0, MathUtils.sin(angle), MathUtils.cos(angle), 0);   
    }   
    ...
    /**
     * Transform the Vector2 based on the matrix defined in this transform
     * 
